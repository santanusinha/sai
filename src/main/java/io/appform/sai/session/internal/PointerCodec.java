...
public class PointerCodec {
    ...
    public static class Anchor {
        ...
        public Anchor(long ts, String id) { this.ts = ts; this.id = id; }
    }

    public static class SessionAnchor {
        public final long updatedAt;
        public final String sessionId;
        public SessionAnchor(long updatedAt, String sessionId) { this.updatedAt = updatedAt; this.sessionId = sessionId; }
    }
}
