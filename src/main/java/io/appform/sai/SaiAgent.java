    ...
    private static String augmentPrompt(String systemPrompt, final AgentConfig config, final Settings settings) {
        return systemPrompt
                + """
                        ...
                        - Your name is %s.
                        - You can use /tmp/sai/%s/scrath/ directory to store any temporary files like todo lists, modified files list and whatever other files you may need during the conversation. No need to clean up the files, they will be automatically deleted after the session ends.
